...
void initPins() {
    ...
    pinMode(PIN_DUMMY_LOAD,      OUTPUT);
   
    pinMode(PIN_ZERO_EN,         OUTPUT);
    pinMode(PIN_CAMERA1_EN,      OUTPUT);
    pinMode(PIN_CAMERA2_EN,      OUTPUT);
  
    pinMode(PIN_SHUTTER1,        OUTPUT);
    pinMode(PIN_SHUTTER2,        OUTPUT);
    ...
    digitalWrite(PIN_ZERO_EN,    LOW);
    digitalWrite(PIN_CAMERA1_EN, LOW);
    digitalWrite(PIN_CAMERA2_EN, LOW);
...
void initPrint(CommunicationInterface ser) {
  ...
  ser.port->print("    ");
  ser.port->print("watchdog_time");
  ser.port->print(": ");
  ser.port->println(watchdog_time);
  
  ser.port->print("    ");
  ser.port->print("dummy_load_enabled");
  ser.port->print(": ");
  ser.port->println(dummy_load_enabled);
