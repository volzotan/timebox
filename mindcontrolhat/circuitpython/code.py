...
try:
    ...
    display = adafruit_displayio_ssd1306.SSD1306(display_bus, rotation=180, width=DISPLAY_SIZE[0], height=DISPLAY_SIZE[1])
...
if i2c is not None:
    ...
    splash.append(label.Label(terminalio.FONT, text="CYCLES:", color=0xFFFFFF, x=25, y=4))
    splash.append(label.Label(terminalio.FONT, text="ELAPSED:", color=0xFFFFFF, x=25, y=16))
...
def trigger():
    ...
    print("{:5.2f} | trigger {}".format(time.monotonic()-time_start, mode))
